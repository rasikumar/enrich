...
const App = () => {
  return (
    <div id='blog' className="mb-10 App xl:h-[700px]">
      <header className="p-4 flex flex-col gap-4 text-center ">
        <h1 className="text-black text-2xl font-semibold text-center">BlogsList</h1>
        <h2 className='text-center text-4xl w-full font-[600]'>In our pursuit of growth, giving back becomes our compass, guiding us to empower and elevate others along the way.</h2>
