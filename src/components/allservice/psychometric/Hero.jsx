...
import { psychometric_hero } from "../../../assets";

const Hero = () => {
  const { title, content } = Psychometric_Content[0];
  ...
  return (
    ...
    >
      ...
      >
        <motion.h1
          className="xl:text-4xl lg:text-3xl text-2xl text-primary font-bold"
          variants={fadeUp}
