...
export const Card = ({ image, title, content }) => {
  ...
  return (
    <div
      className="flex flex-col xl:w-[16rem] lg:w-[14rem] w-[16rem] h-72 m-auto p-5 bg-gradient-to-b from-secondary to-black gap-4 md:mr-10 mr-2 rounded-sm mt-10 md:mb-28 mb-10 border"
