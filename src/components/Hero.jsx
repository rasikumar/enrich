...
const Hero = () => {
  return (
    <motion.div
      ...
      exit={{ opacity: 0 }}
      id="hero"
      className="bg-Hero bg-no-repeat -mt-[5.4rem] bg-cover bg-center p-4 md:p-10 py-26 flex flex-col-reverse md:flex-row justify-evenly items-center min-h-64 z-0 h-screen "
    >
      <motion.div
        initial={{ x: -50 }}
        animate={{ x: 0 }}
