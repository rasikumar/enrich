...
const Hero = () => {
    ...
    return (
        <div id='hero' className="bg-gradient-to-r to-yellow-100 from-yellow-200 p-4 md:p-10 py-26 flex flex-col-reverse md:flex-row justify-evenly items-center min-h-64 z-0 relative md:h-[520px] xl:h-[720px]">
