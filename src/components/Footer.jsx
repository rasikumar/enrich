    ...
    <div className="bg-slate-100 ">
      <div className='py-6 px-2 m-auto xl:w-96 md:w-96 gap-3 flex flex-col'>
        <h1 className="text-center xl:text-lg ">Subcribe and get Our Newsletters</h1>
          ...
          <button className='delay-75 px-4 py-2 w-full rounded text-slate-100 xl:text-sm bg-yellow-600 hover:bg-slate-100 hover:text-yellow-600 m-auto'>Subscribe</button>
        </div>
