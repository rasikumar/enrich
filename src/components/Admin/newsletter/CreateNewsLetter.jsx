    ...
    <div>
      ...
      {isPreview && (
        ...
        >
          ...
          >
            <div className="bg-white px-3 py-4 sticky items-end flex justify-end top-0 w-full">
              <IoClose
            ...
            <div className="px-5">
              <div className="border border-blue-600 p-3">
                ...
                <div className="mt-4">
                  ...
                  >
                    🎯 In Focus:{" "}
                    <span className="text-secondary">SafetyNet</span> Series
                  </h4>
                ...
                <div className="mt-4">
                  <h2 className="text-lg font-bold mb-2">
                    🌍 Join Our{" "}
                    <span className="text-secondary">Community</span> Online
                  </h2>
                  <p className="mb-4">
                  ...
                  <h2 className="text-lg font-bold mb-2 mt-4">
                    🗣 We Value Your{" "}
                    <span className="text-secondary">Voice</span>
                  </h2>
                  <p className="mb-4">
